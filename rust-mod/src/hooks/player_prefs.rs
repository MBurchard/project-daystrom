...
const HASKEY_SUPPRESS: &[&str] = &[
    ...
    "StarbaseDamageSeen",
    "account_local_data",
    "auto_speedup_confirm_menu_popup_key",
    "chat_forcelandscape",
    "completed_missions_count_for_permission_dialog",
    ...
    "mission/holodeck",
    "DCE_LAST_EVENT_KEY",
    "GalaxyMiningToggleInfoSeen",
    "MM_daily_milestone_time",
    "MiningPVPWarning",
    "reported_players",
    "visit_galaxy_first_time",
    "slide_show_seen",
    "rtc_proxy",
